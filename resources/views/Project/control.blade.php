...
<div class="sixteen wide  column ui segment" style="margin: 10px !important">
	...
	<table class="ui celled table">
		...
		<thead>
			...
			<th style="width: 14%"><center>Satellite</center></th>
			<th style="width: 14%"><center>Start Time</center></th>
			<th style="width: 14%"><center>End time </center></th>
			<th style="width: 14%"><center>Start<br> Azimuth</center></th>
			<th style="width: 14%"><center>Start<br> Elevation</center></th>
			<th style="width: 16%"><center>Delete</center></th>
			...
			<tr>
				...
				<td> 
					<form action="{{ route('Project.deleteTimeControl') }}"  method='post'>
						...
						<center><button class='ui red button' type='submit'>ลบการตั้งค่าล่วงหน้า</button></center>
					</form>
				</td>
